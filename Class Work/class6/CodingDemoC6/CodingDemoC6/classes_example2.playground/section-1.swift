...
//this is a class method instead of an instance method. and click on the eye on the right in order to preview (if eye doesn't show up its cause something is erroring in the code and cause it's a compiled language, all of it has to work in order to see anything
